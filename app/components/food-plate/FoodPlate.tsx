...
const FoodPlate: React.FC<FoodPlateProps> = ({ step }) => {
  return (
    <div className="relative w-52 h-52 bg-white rounded-full shadow-2xl border-8 border-gray-300">
      <div className="absolute inset-2 bg-gray-100 rounded-full shadow-inner"></div>

      {step >= 1 && <Image className='absolute top-0' style={{width: "auto"}} src={foods.fish} width={100} height={100} alt='food-1' priority />}
      {step >= 2 && <Image className='absolute top-0 right-0' style={{width: "auto"}} src={foods.egg} width={100} height={100} alt='food-4' priority />}
      {step >= 3 && <Image className='absolute top-16 right-0' style={{width: "auto"}} src={foods.pizza} width={100} height={100} alt='food-2' priority/>}
